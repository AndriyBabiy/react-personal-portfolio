    ...
    <div className="contact-app">
      ...
      <div className="contact-cards">
        ...
        <a
          ...
          className="contact-card"
        >
          <div className="contact-icon" style={{ background: 'linear-gradient(135deg, #333, #111)' }}>
        ...
        <a
          ...
          className="contact-card"
        >
          <div className="contact-icon" style={{ background: 'linear-gradient(135deg, #0A66C2, #004182)' }}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="white">
